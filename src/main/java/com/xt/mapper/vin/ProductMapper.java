...
public interface ProductMapper {
     ...
     * @return List<Product>
     */
    @Select("select p.product_name,pm.model_name,pt.type_name,p.product_unit,p.product_stock,p.retail_price,p.min_price,p.cost_price,p.trade_price,p.product_state,p.serial_number from product as p" +
