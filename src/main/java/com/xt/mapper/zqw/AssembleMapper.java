...
public interface AssembleMapper {
     ...
     * @return
     */
    @Select("SELECT assemble.*,sys_user.name,product.product_name,dispatchedworker.billid,productionplan.* from assemble,sys_user,product,productionplan,dispatchedworker\n" +
